            ...
            <div class="wrapper">
                ...
                <div id="wrapper-all">
                    ...
                    <option value="11">2020</option>
                        ...
                        <div id="wrapper-item" class="strip">--</div>
                    </div>
                    <div id="wrapper-item" class="custom-select" style="width:200px">
                        <select>
                            <option value="0">Pilih Bulan:</option>
                ...
                <table class="table2">
                    <tr class="table21">
                        <th colspan="3" style="text-align: right;">Mei 2020</th>
                    </tr>
                    <tr class="tabble21">
                        <th colspan="3">Pendapatan</th>
                    </tr>
                    <tr>
                        <td class="table21">Pendapatan Bersih</td>
                        <td class="table21"></td>
                        <td>0</td>
                    </tr>
                    <tr>
                        <th colspan="3" class="table21">Harga Pokok Penjualan</th>
                    </tr>
                    <tr>
                        <td class="table21">LABA/RUGI KOTOR</td>
                        <td class="table21">500.000</td>
                        <td></td>
                    </tr>
                </table>
        </section>
